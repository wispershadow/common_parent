...
class IpRateLimiterFilter: Filter {
    companion object {
        private val logger: Logger = LoggerFactory.getLogger(IpRateLimiterFilter::class.java)
    }
    ...
    override fun doFilter(servletRequest: ServletRequest, servletResponse: ServletResponse,
        ...
        val rateLimiterName = RateLimitKeyGen.ip(servletRequest as HttpServletRequest)
